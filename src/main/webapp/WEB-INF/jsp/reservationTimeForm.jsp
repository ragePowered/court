...
<form:form method="post" modelAttribute="reservation">
    <table>
        <tr>
            ...
            <td><forn:errors path="fromDate" cssClass="error"/></td>
        </tr>
        <tr>
            <td>To Date</td>
            <td><form:input path="toDate"/></td>
            <td><forn:errors path="toDate" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Period</td>
            <td><form:select path="period" items="${periods}"/></td>
            <td><forn:errors path="period" cssClass="error"/></td>
        </tr>
        <tr>
            <td>Hour</td>
            <td><form:input path="hour"/></td>
            <td><forn:errors path="hour" cssClass="error"/></td>
        </tr>
        <tr>
            <td colspan="3">
