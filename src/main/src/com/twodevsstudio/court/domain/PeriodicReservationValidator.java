...
public class PeriodicReservationValidator implements Validator {
	...
	public void validateCourt(Object target, Errors errors) {
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "court.name", "required.courtName", "Court name is required");
	}
	...
	public void validatePlayer(Object target, Errors errors) {
		ValidationUtils.rejectIfEmpty(errors, "player.name", "required.playerName", "Player name is required");
	}
